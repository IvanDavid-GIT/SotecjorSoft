  ...
  <body class="nav-md">
    <div class="container body" > 
      <div class="main_container">
        <div class="col-md-3 left_col" style="background: rgb(42 63 84)">
          <div class="left_col scroll-view" style="background: rgb(42 63 84)">
            <div class="navbar nav_title" style="background: #304961" >
              <a href="" class="site_title"><svg xmlns="http://www.w3.org/2000/svg" width="60" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
            ...
            <div class="profile clearfix">
                ...
                <span><h2 style="margin-left:75px;">Bienvenido</h2></span>
                </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 20 20" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                <h3><a href="/" style="color:white">Dashboard</a></h3>
                </div>
                <br/>
                <div>
                ...
                <h3><a href="<?php echo e(route('material.index')); ?>" style="color:white">Materiales</a></h3>
                </div>
                <br/>
                <div>
                ...
                <h3><a href="<?php echo e(route('categoria.index')); ?>" style="color:white">Entradas</a></h3>
                </div>
                <br/>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-upload"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                <h3><a href="<?php echo e(route('categoria.index')); ?>" style="color:white">Salidas</a></h3>
                </div>
                <br/>
                <div>
                ...
                <h3><a href="<?php echo e(route('reporte.index')); ?>" style="color:white">Reportes</a></h3>
                </div>
                <br/>
                <br/>
                <br/>
                ...
                <h3><a href="" style="color:white">Configuación</a></h3>
                </div>
              </div>
        ...
        <!-- top navigation -->
        <div class="top_nav" >
          <div class="nav_menu" style="border: 0;background: #304961">
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="background:#ECF0F5">
      ...
      <div class="container-fluid" style="background:white">
        ...
        <!-- footer content -->
        <footer style="background:#ECF0F5">
...
<?php /**PATH A:\Git Sotecjot\sotecjo\resources\views/layout.blade.php ENDPATH**/ ?>