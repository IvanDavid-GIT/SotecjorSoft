...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                        <label for="id_rol" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Rol:')); ?></label>

                            <div class="col-md-6">
                                <input id="id_rol" type="text" class="form-control <?php $__errorArgs = ['id_rol'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="id_rol" value="<?php echo e(old('id_rol')); ?>" required autocomplete="id_rol" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                        <label for="id_tipo_documento" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Tipo de documento:')); ?></label>

                            <div class="col-md-6">
                                <input id="id_tipo_documento" type="text" class="form-control <?php $__errorArgs = ['id_tipo_documento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="id_tipo_documento" value="<?php echo e(old('id_tipo_documento')); ?>" required autocomplete="id_tipo_documento" autofocus>

                                <?php $__errorArgs = ['id_tipo_documento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                        <label for="numero_documento" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Número documento:')); ?></label>

                            <div class="col-md-6">
                                <input id="numero_documento" type="text" class="form-control <?php $__errorArgs = ['numero_documento'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="numero_documento" value="<?php echo e(old('numero_documento')); ?>" required autocomplete="numero_documento" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="estado" value="<?php echo e(old('estado')); ?>" required autocomplete="estado" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\Git Sotecjor\sotecjo\resources\views/auth/register.blade.php ENDPATH**/ ?>