...
<form action="<?php echo e(route('proyectosdeobras.store')); ?>" method="POST" style="text-align:center">
    <?php echo csrf_field(); ?>
    <div class="card-body">
        <div class="row">
            <div class="col-4">
...
unset($__errorArgs, $__bag); ?>" name="nombre" value="<?php echo e(old('nombre')); ?>" maxlength="50" onkeyup="soloLetras(this)">
...
unset($__errorArgs, $__bag); ?>" name="lugar" value="<?php echo e(old('lugar')); ?>" maxlength="40" onkeyup="soloLetras(this)">
...
unset($__errorArgs, $__bag); ?>" name="Responsable" value="<?php echo e(old('Responsable')); ?>" maxlength="50" onkeyup="soloLetras(this)">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control " name="Observacion" maxlength="200"><?php echo e(old('Observacion')); ?></textarea>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SotecjorSoft\resources\views/proyectosdeobras/create.blade.php ENDPATH**/ ?>