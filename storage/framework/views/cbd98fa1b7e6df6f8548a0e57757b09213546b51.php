...
<div class="text-center" style="margin-left: 115px;">
  ...
  <a href="<?php echo e(route('proyectosdeobras.create')); ?>" title="Crear" class="float-right btn btn-outline-primary"><i class="fas fa-plus fa-md fa-fw"></i>Registrar</a>
...
<!-- aqui -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SotecjorSoft\resources\views/proyectosdeobras/index.blade.php ENDPATH**/ ?>