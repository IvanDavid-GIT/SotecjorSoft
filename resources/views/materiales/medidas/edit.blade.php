...
<form action="{{ route('medidas.update',$medidas->id) }}" method="POST" style="text-align:center">
    @csrf
    <div class="card-body">
        <div class="row">
            <div class="col-12">
                ...
                <label>Nombre</label>
                <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{ $medidas->nombre }}" maxlength="20" onkeyup="soloLetras(this)">
