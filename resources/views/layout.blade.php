          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <div class="nav side-menu">
                <li style="width: 230px;"><a href="{{route('dashboard.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                ...
                <li style="width: 230px;"><a href="{{route('usuario.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                ...
                @endif
                <li style="width: 230px;"><a href="{{route('categoria.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 22 22" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                ...
                <li style="width: 230px;"><a href="{{route('material.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 22 22" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive">
                ...
                <li style="width: 230px;"><a href="{{route('proyectosdeobras.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-truck">
                ...
                <li style="width: 230px;"><a href="{{route('entradas.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download">
                ...
                <li style="width: 230px;"><a href="{{route('salidas.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-upload">
                      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                ...
                <li style="width: 230px;"><a href="{{route('reporte.index')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="75" height="24" viewBox="0 0 22 22" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard">
            ...
            <ul class=" navbar-right">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{ route('logout') }}" onclick="CerrarSesion()"><i class="fas fa-sign-out-alt fa-md fa-fw"></i>
                    {{ __('Cerrar sesión') }}
                  </a>
